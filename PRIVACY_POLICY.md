...
- **Chat Messages**: The app stores chat messages locally on your device using Room database. These messages are stored on your device and are not transmitted to our servers unless you explicitly configure a remote server.
...
- **No Cloud Storage**: We do not store your chat messages or personal data on our servers.
